...
class EXPORT_SERVER_DLL Server : private ISteamNetworkingSocketsCallbacks, public ReferenceCount
{
public:
	Server();
...
INLINE Server::clientmap_t *Server::get_clients()
{
	return &_clients_by_address;
}

INLINE Server::entmap_t *Server::get_entlist()
{
	return &_entlist;
}

extern EXPORT_SERVER_DLL Server *g_server;