#include "net/dt_send.h"

#include <aa_luse.h>

void SendProxy_Int8( SendProp *prop, void *data, Datagram &dg )
{
	dg.add_int8( ( *(int8_t *)data ) );
}

void SendProxy_Int16( SendProp *prop, void *data, Datagram &dg )
{
	dg.add_int16( ( *(int16_t *)data ) );
}

void SendProxy_Int32( SendProp *prop, void *data, Datagram &dg )
{
	std::cout << "SendProxy_int32 " << ( *(int32_t *)data ) << std::endl;
	dg.add_int32( ( *(int32_t *)data ) );
}

void SendProxy_Int64( SendProp *prop, void *data, Datagram &dg )
{
	dg.add_int64( ( *(int64_t *)data ) );
}

void SendProxy_Uint8( SendProp *prop, void *data, Datagram &dg )
{
	dg.add_uint8( ( *(uint8_t *)data ) );
}

void SendProxy_Uint16( SendProp *prop, void *data, Datagram &dg )
{
	dg.add_uint16( ( *(uint16_t *)data ) );
}

void SendProxy_Uint32( SendProp *prop, void *data, Datagram &dg )
{
	std::cout << "SendProxy_Uint32 " << ( *(uint32_t *)data ) << std::endl;
	dg.add_uint32( ( *(uint32_t *)data ) );
}

void SendProxy_Uint64( SendProp *prop, void *data, Datagram &dg )
{
	dg.add_uint64( ( *(uint64_t *)data ) );
}

void SendProxy_Float32( SendProp *prop, void *data, Datagram &dg )
{
	std::cout << "SendProxy_Float32 " << ( *(PN_float32 *)data ) << std::endl;
	dg.add_float32( ( *(PN_float32 *)data ) );
}

void SendProxy_Float64( SendProp *prop, void *data, Datagram &dg )
{
	dg.add_float64( ( *(PN_float64 *)data ) );
}

void SendProxy_String( SendProp *prop, void *data, Datagram &dg )
{
	std::cout << "SendProxy_String " << *( std::string * )data << std::endl;
	dg.add_string( *( std::string * )data );
}

void SendProxy_CString( SendProp *prop, void *data, Datagram &dg )
{
	std::cout << "SendProxy_CString " << std::string( (char *)data ) << std::endl;
...
template <class T>
void SendProxy_Vec( SendProp *prop, void *data, Datagram &dg )
{
	T vec = *(T *)data;
